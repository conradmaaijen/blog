...
global_variables() {
    ...
    global_twitter_username="conradmaaijen"
    ...
    header_file="custom_header.html"
    footer_file=""
    ...
    # URL where you can view the pcost while it's being edited
...
create_html_page() {
    ...
    # html, head
    {
        ...
        # body divs
        echo '<div class="terminal container" id="divbodyholder">'
        echo '<div class="terminal-nav"><div class="header">'
        # blog title
        echo '<div class="logo terminal-prompt" id="title">'
        cat .title.html
        ...
        if [[ $index == no ]]; then
            ...
            echo "<h1><a class=\"ablack\" href=\"$file_url\">"
...
rebuild_index() {
	...
	echo "<li><a href=\"/all_tags.html\">$> cd tags/</a></li>"
	echo "<li><a href=\"/all_posts.html\">$> cd posts/</a></li>"
	echo "</ul><p><br></p></div>"
...
create_includes() {
    {
        echo "<span class=\"nomargin\"><a class=\"ablack\" href=\"$global_url/$index_file\">$global_title</a>:~# </span>"
...
usage() {
    ...
    echo "    commit [message]        commits all changed files and push to github"
    echo "                            when 'message' is empty 'wip' is used as message"
    echo ""
